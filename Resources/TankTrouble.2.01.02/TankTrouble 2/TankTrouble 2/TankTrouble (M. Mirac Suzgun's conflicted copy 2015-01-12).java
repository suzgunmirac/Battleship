...
public class TankTrouble extends Canvas implements Runnable {
  ...
  public static final int WIDTH = 1024; // screen width
  ...
  private void initializeGame(){
    ...
    menu = new Menu();
    // Menu'ye eklemeler yapýlacak! (TO DO)
    map = new Map(100,50,this);
    // Map'e width and height gonderilecek ! (TO DO)
    physics = new Physics(this);
    scoring = new Scoring(this);
    
    player1 = new Tank("blue",0,this);
    player2 = new Tank("red",0,this);
