     ...
     for (int j = 1; j<=mazeWIDTH; j++){
       ...
       if (southMaze[i][j]){
         //  walls.add(new Rectangle2D.Double(originX + (j-1)*100-10, originY+(i-1)*100, wallWidth,110));
          walls.add(new Rectangle2D.Double(originX + (j-1)*100, originY+(i-1)*100, wallWidth,90));
       ...
       if (northMaze[i][j]){ // 
          ...
          walls.add(new Rectangle2D.Double(originX + (j)*100, originY+(i-1)*100, wallWidth,90));
          mazeBinary[2*(j-1)][2*(i-1)] = 1;
           wallType.add(1);
       }
       if (eastMaze[i][j]){
         //  walls.add(new Rectangle2D.Double(originX + (j-1)*100, originY +(i-1)*100-10, 110,wallWidth));
         walls.add(new Rectangle2D.Double(originX + (j-1)*100, originY +i*100, 90,wallWidth));
         mazeBinary[2*(j-1)][2*(i-1)+1] = 1;
           wallType.add(0);
       } 
       if (westMaze[i][j]){
          // walls.add(new Rectangle2D.Double(originX + j*100, originY +i*100-wallWidth-10, 110,wallWidth));
         walls.add(new Rectangle2D.Double(originX + (j-1)*100, originY +(i-1)*100, 90,wallWidth));
