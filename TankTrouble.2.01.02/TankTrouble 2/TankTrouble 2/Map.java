...
public class Map{
  ...
  /* 
   ...
   public void mazeInit (){
     ...
     northMaze = new boolean [MAXSIZE+2][MAXSIZE+2];
     southMaze = new boolean [MAXSIZE+2][MAXSIZE+2];
     eastMaze = new boolean [MAXSIZE+2][MAXSIZE+2];
     westMaze = new boolean [MAXSIZE+2][MAXSIZE+2];
