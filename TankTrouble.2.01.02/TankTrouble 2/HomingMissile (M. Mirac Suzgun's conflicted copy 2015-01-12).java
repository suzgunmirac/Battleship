...
public class HomingMissile extends Bullet
{
  ...
  public HomingMissile(double xCoordinate, double yCoordinate, int type, TankTrouble tanktrouble,Tank tankNew, Tank anotherTank)
  {
    super(xCoordinate,yCoordinate,type,tanktrouble,tankNew);
